...
(2, 10, 'descriptor_l3', 'When a wine tastes off/corky, which three actions should you take?',
  jsonb_build_object('prompt', 'When a wine tastes off/corky, which three actions should you take?', 'descriptors', ARRAY['Smell cork first to diagnose', 'Offer immediate replacement', 'Taste to confirm issue', 'Apologise without defensiveness', 'Insist nothing is wrong'], 'correctIndices', ARRAY[0, 1, 2], 'explanation', 'Guest satisfaction is paramount; swift action and apology matter.'),
