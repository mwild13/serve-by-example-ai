// ── Shared types & static content for the Scenario Trainer ──────────────────

export type Module = "bartending" | "sales" | "management";

export type ReviewItem = { module: string; scenarioIndex: number; masteryLevel: number; consecutiveFails: number };
...
export const SCENARIOS: Record<Module, Scenario[]> = {
  bartending: [
    {
...
export const SCENARIO_INSIGHTS: Record<Module, string[]> = {
  bartending: [
...
export const MODULE_META: Record<Module, { label: string; description: string; nextUp: string; color: string }> = {
  bartending: {
