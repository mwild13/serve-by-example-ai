...
export const KB_CATEGORIES: Record<KBCategory, { label: string; description: string; color: string; subCategories: KBSubCategory[] }> = {
  spirits: {
    ...
    subCategories: [
      ...
      { label: "Australian Spirits", slug: "australian-spirits" },
    ],
  },
  beer: {
    label: "Beer 101",
...
export const KB_ENTRIES: KBEntry[] = [
  ...
  // ─── SPIRITS: Australian Spirits ───────────────────────────
  {
    title: "Four Pillars Gin: Australian Craft Gin",
    category: "spirits",
    subCategory: "australian-spirits",
    content: "Four Pillars Distillery, based in Healesville, Victoria, produces award-winning craft gin using Australian botanicals. Their signature gin combines juniper with citrus, anise, and carefully selected Australian botanicals. The distillery has become a symbol of Australia's craft spirits revolution and offers diverse styles including Navy Strength and flavoured expressions.",
    keyFacts: [
      "Founded 2013 in Healesville, Victoria",
      "Signature Gin: juniper-forward with citrus and spice balance",
      "Navy Strength: 57% ABV, more intense botanical profile",
      "Pink Gin: features native Australian fruits and botanicals",
      "Used in iconic Australian cocktails and perfect for teaching quality G&Ts",
    ],
    tags: ["australian-spirits", "gin", "craft-spirits", "victoria"],
  },
  {
    title: "Starward Whisky: Australian Single Malt",
    category: "spirits",
    subCategory: "australian-spirits",
    content: "Starward Distillery, located in Melbourne, produces innovative Australian single malt whisky using local ingredients and techniques. The distillery's location in Australia's wine region influences production — they finish their whisky in wine barrels, creating fruit-forward expressions. Starward represents the modern Australian whisky movement.",
    keyFacts: [
      "Founded 2007 in Melbourne, Victoria",
      "Single malt whisky using Australian barley and local water",
      "Wine barrel finishing creates fruit-forward character",
      "Flagship 'Two-Fold' expression is smooth and accessible",
      "Perfect for teaching Australian terroir and modern whisky-making",
    ],
    tags: ["australian-spirits", "whisky", "craft-spirits", "victoria"],
  },
  {
    title: "Archie Rose Distilling Co.: Sydney's Craft Distillery",
    category: "spirits",
    subCategory: "australian-spirits",
    content: "Archie Rose, based in Rosebery, Sydney, is one of Australia's leading craft distilleries. They produce innovative gin, vodka, whisky, and rum using modern techniques and sustainable practices. The distillery is known for experimental approaches and collaboration with Australian bartenders to create spirits tailored for mixing.",
    keyFacts: [
      "Founded 2012 in Rosebery, Sydney",
      "Produces gin, vodka, whisky, and rum with a focus on Australian craft",
      "Gin: botanically complex, citrus-forward",
      "Vodka: clean and versatile, excellent in modern cocktails",
      "Sustainability focus and local ingredient sourcing",
    ],
    tags: ["australian-spirits", "gin", "vodka", "craft-spirits", "sydney"],
  },
  {
    title: "Bundaberg Rum: Queensland Heritage",
    category: "spirits",
    subCategory: "australian-spirits",
    content: "Bundaberg Rum, established in 1888 in Bundaberg, Queensland, is Australia's oldest and most iconic rum producer. Made from locally-grown sugarcane and aged in oak, Bundaberg Rum has a distinctive rich, molasses-forward character. It's a cornerstone of Australian hospitality and the foundation for teaching Australian spirits pride.",
    keyFacts: [
      "Established 1888 — oldest continuously operating rum distillery in Australia",
      "Produced in Bundaberg, Queensland using local sugarcane",
      "Rich, molasses-heavy character from proper ageing",
      "White Rum: clean for Mojitos and Daiquiris",
      "Dark Rum: rich for Old Fashioneds and tropical cocktails",
    ],
    tags: ["australian-spirits", "rum", "heritage", "queensland"],
  },
  {
    title: "Australian Whisky: The Starward Story and Beyond",
    category: "spirits",
    subCategory: "australian-spirits",
    content: "Australia's whisky industry has grown from almost nothing to world-recognition in just two decades. Starward, Lark (Tasmania), and Manly Spirits represent the diversity of Australian whisky production. Each region develops unique terroir-driven expressions, proving that Australian whisky is not an imitation of Scotch but a distinct category with its own character.",
    keyFacts: [
    ...
    tags: ["australian-spirits", "whisky", "craft-spirits", "terroir"],
  },
];
